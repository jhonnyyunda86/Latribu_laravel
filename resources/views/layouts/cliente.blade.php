...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'La Tribu - Cliente') }}</title>
                ...
                <div class="flex flex-col flex-1 min-h-0">
                    ...
                    <div class="flex items-center gap-3 px-6 py-5 border-b border-white/5">
                        ...
                        <div>
                            ...
                            <span class="text-[9px] tracking-wider text-gray-500 uppercase font-semibold">Familia & Sabor</span>
                        </div>
                    </div>
                    ...
                    <div class="px-6 py-6 border-b border-white/5 flex flex-col items-center text-center">
                        ...
                        <span class="text-[10px] text-gray-500 uppercase font-bold tracking-wider">Cliente Distinguido</span>
                    </div>
