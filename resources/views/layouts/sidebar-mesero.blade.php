<aside class="fixed inset-y-0 left-0 z-50 w-64 bg-[#121619] text-gray-300 flex flex-col justify-between transition-transform duration-300 transform md:translate-x-0 md:sticky md:top-0 md:h-screen border-r border-[#d4af37]/20"
    ...
    <div class="flex flex-col flex-1 min-h-0">
        ...
        <div class="px-6 py-5 border-b border-white/5 flex flex-col items-center text-center">
            ...
            <span class="text-[10px] text-gray-400 uppercase tracking-wider font-semibold">Mesero</span>
        </div>
        ...
        <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route('mesero.menu') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-semibold tracking-wider transition-all duration-200 {{ request()->routeIs('mesero.menu') ? 'bg-[#d4af37] text-[#121619] shadow-md' : 'text-gray-400 hover:bg-white/5 hover:text-[#d4af37]' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <a href="{{ route('mesero.mesas') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-semibold tracking-wider transition-all duration-200 {{ request()->routeIs('mesero.mesas') ? 'bg-[#d4af37] text-[#121619] shadow-md' : 'text-gray-400 hover:bg-white/5 hover:text-[#d4af37]' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <a href="{{ route('mesero.pedidos') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-semibold tracking-wider transition-all duration-200 {{ request()->routeIs('mesero.pedidos') ? 'bg-[#d4af37] text-[#121619] shadow-md' : 'text-gray-400 hover:bg-white/5 hover:text-[#d4af37]' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <a href="{{ route('mesero.reservas') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-semibold tracking-wider transition-all duration-200 {{ request()->routeIs('mesero.reservas') ? 'bg-[#d4af37] text-[#121619] shadow-md' : 'text-gray-400 hover:bg-white/5 hover:text-[#d4af37]' }}">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
